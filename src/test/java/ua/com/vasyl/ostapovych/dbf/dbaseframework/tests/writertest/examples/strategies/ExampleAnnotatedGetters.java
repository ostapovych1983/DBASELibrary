...
import static ua.com.vasyl.ostapovych.dbf.dbaseframework.api.dbf.enums.DBFGenerateStrategies.ANNOTATED_GETTERS;
import static ua.com.vasyl.ostapovych.dbf.dbaseframework.api.dbf.types.DBFType.*;

@SuppressWarnings("ALL")
@DBFTable(accessMode = ANNOTATED_GETTERS)
public class ExampleAnnotatedGetters {
    ...
    public boolean equals(Object o) {
        ...
        ExampleAnnotatedGetters that = (ExampleAnnotatedGetters) o;
